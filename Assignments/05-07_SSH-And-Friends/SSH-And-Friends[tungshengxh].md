...
I proceeded with the following modifications.
every occurrence of methods in this article should be replace with econ-ark to ensure the validity of the code.
In addition, the path methods@localhost:/home/methods/GitHub/Methods/Assignments/* /tmp/Methods/Assignments I believe should be scp -r econ-ark@localhost:/home/econ-ark/GitHub/ccarrollATjhuecon/Methods/Assignments/* /tmp/Methods/Assignments
to make the code work.
And the same modification should be applied to the command sudo sshfs -o allow_other -o IdentityFile=~/.ssh/id_rsa.pub methods@localhost:/home/methods/GitHub/Methods /mnt/Methods. 
